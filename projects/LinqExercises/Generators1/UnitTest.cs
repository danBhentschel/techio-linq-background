...
namespace Generators1
{
    ...
    public class UnitTest
    {
        ...
        {
            Utils.TechioMessage("About to test AddTwoThenDouble().Take(10)");
            ...
            Utils.TechioMessage("About to test AddTwoThenDouble().Skip(13).Take(4)");
            ...
            Utils.TechioMessage(string.Empty);
            Utils.TechioMessage("About to test AddTwoThenDouble().Skip(28).First()");
