...
namespace Background1
{
    ...
    public class UnitTest
    {
        ...
        {
            Utils.TechioMessage("About to test DoTransform(new List<int> { 10, 20, 30 }, x => x / 10)");
            ...
            Utils.TechioMessage("About to test DoTransform(new List<int> { 7, 11, 15, 19 }, x => x - 7)");
            ...
            Utils.TechioMessage(string.Empty);
            Utils.TechioMessage("About to test DoTransform(new List<int> { 1, 1, 1, 2, 2, 2 }, x => 20)");
