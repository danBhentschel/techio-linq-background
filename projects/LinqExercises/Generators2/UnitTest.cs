...
namespace Generators2
{
    ...
    public class UnitTest
    {
        ...
        {
            Utils.TechioMessage("About to test: AddTwoThenDouble(10)");
            ...
            Utils.TechioMessage("About to test: AddTwoThenDouble(17).Count()");
            ...
            Utils.TechioMessage(string.Empty);
            Utils.TechioMessage("About to test: AddTwoThenDouble(17).Skip(13)");
            answer = string.Join(" ", enumerable.Skip(13));
            Utils.AssertAreEqual("508 510 1020 1022", answer, "Values 14 - 17");

            Utils.TechioMessage(string.Empty);
            Utils.TechioMessage("About to test: AddTwoThenDouble(30).Count()");
